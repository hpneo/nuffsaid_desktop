...
var Relation = function Relation(options) {
  ...
  if (this.values.where) {
    var keys = Object.keys(this.values.where),
        self = this;

    keys.forEach(function(key) {
      value = self.values.where[key];
      self.query = self.query.where(table[key].equals(value));
    })
